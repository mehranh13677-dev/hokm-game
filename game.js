 ...
 * game.js
 *
 * Version: 2.4 (Full Structure + Random Iranian Bot Names + Enhanced Flow)
 * ================================================================
 */

/* ================================================================
   1. CONSTANTS & IRANIAN BOT NAMES
================================================================ */
...
const BOT_NAMES = [
    "آرش", "سارا", "کوروش", "پریسا", "امیر", "فاطمه", "رضا", "زهرا", "محمد", "نیلوفر",
    "دانیال", "مینا", "پویا", "رها", "آرمان", "غزل", "سینا", "باران", "سهیل", "الناز",
    "سهراب", "نازنین", "بهنام", "مهسا", "کیوان", "رویا", "فرهاد", "تبسم", "شایان", "شیرین",
    "کامران", "پگاه", "رامین", "هانیه", "بیژن", "پردیس", "سهراب", "ترانه", "اشکان", "آوا",
    "سامان", "مهدیس", "سهراب", "یسنا", "نریمان", "دلارام", "پیمان", "سحر", "فرزاد", "یسنا"
];
...
/* ================================================================
   6. SCREEN NAVIGATION (اصلاح پرش صفحه به پایین)
================================================================ */
...
function showScreen(screenId, pushHistory = true) {
    ...
    // جلوگیری از اسکرول ناخواسته به پایین صفحه
...
function startOffline4PGame() {
    ...
    if (getElement("westPlayerName") && pWest) getElement("westPlayerName").textContent = pWest.name;
    if (getElement("northPlayerName") && pNorth) getElement("northPlayerName").textContent = pNorth.name;
    if (getElement("eastPlayerName") && pEast) getElement("eastPlayerName").textContent = pEast.name;

    initializeHands();
    showLoading("در حال بر زدن و پخش کارت‌ها...");
    ...
    setTimeout(() => {
        ...
        showToast("حاکم شمایید! حکم را انتخاب کنید 👑", "👑", 3500);
    }, 500);
}
...
function startOffline2PGame() {
    ...
    initializeHands();
    showLoading("بارگذاری میز دو نفره...");
...
function setTrumpSuit(suit) {
    ...
    updateGameUI();
    hideLoading();
    showToast(`حکم: ${SUITS[suit].name}`, "👑", 2500);
...
/* ================================================================
   10. EVENT BINDINGS & BACK BUTTON CONTROL
================================================================ */
...
function initializeApp() {
    ...
    showScreen("homeScreen");
    console.log("Hokm game.js 2.4 fully initialized.");
}
