 ...
 * game.js
 *
 * Version: 2.7 (Full Structure + Authentic Hokm Dealing Rule)
 * ================================================================
 */
...
/* ================================================================
   9. AUTHENTIC HOKM DEALING & GAME FLOW
================================================================ */
...
function dealFirstCards() {
    ...
    showLoading("توزیع ۵ کارت اول برای تعیین حکم...");
    ...
    setTimeout(() => {
        ...
        renderPlayerHand();
        showToast("۵ کارت اول پخش شد. حکم را انتخاب کنید 👑", "👑", 3500);
    }, 800);
}

// مرحله دوم: پخش مابقی کارت‌ها (۸ کارت بعدی) پس از انتخاب حکم
...
function setTrumpSuit(suit) {
    ...
    showLoading("در حال پخش مابقی کارت‌ها...");
...
function initializeApp() {
    ...
    showScreen("homeScreen");
    console.log("Hokm game.js 2.7 fully initialized.");
}
