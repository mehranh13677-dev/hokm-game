 ...
 * game.js
 *
 * Version: 2.3 (Full Structure + Offline 2P/4P + Back Button Control)
 * ================================================================
 */
...
/* ================================================================
   6. SCREEN NAVIGATION (با پشتیبانی از دکمه Back)
================================================================ */
...
function createDemoPlayers4P() {
    return [
        ...
        { id: "p2", name: "ربات غرب", seat: 1, team: "B", local: false },
        { id: "p3", name: "ربات شمال", seat: 2, team: "A", local: false },
        { id: "p4", name: "ربات شرق", seat: 3, team: "B", local: false }
    ];
}
...
function createDemoPlayers2P() {
    return [
        { id: "p1", name: state.player.name, seat: 0, team: "A", local: true },
        { id: "p2", name: "هوش مصنوعی", seat: 2, team: "B", local: false }
    ];
}
...
function startOffline4PGame() {
    ...
    if (northName) northName.textContent = "ربات شمال";
...
function startOffline2PGame() {
    ...
    const northName = getElement("northPlayerName");
    if (northName) northName.textContent = "هوش مصنوعی";
...
function initializeApp() {
    ...
    showScreen("homeScreen");
    console.log("Hokm game.js 2.3 fully initialized.");
}
