 ...
 * game.js
 *
 * Version: 2.6 (Full Structure + Natural AI Delay & Clear Table Render)
 * ================================================================
 */

/* ================================================================
   1. CONSTANTS & IRANIAN BOT FIRST NAMES (دخترا و پسرا)
================================================================ */
...
function runComputerTurnIfNeeded() {
    ...
    // مکث ۱۱۰۰ میلی‌ثانیه‌ای برای شبیه‌سازی فکر کردن و بازی طبیعی ربات
    setTimeout(() => {
...
function initializeApp() {
    ...
    showScreen("homeScreen");
    console.log("Hokm game.js 2.6 fully initialized.");
}
