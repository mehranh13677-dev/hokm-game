 ...
 * game.js
 *
 * Version: 2.9 (Full Structure + Authentic Hokm Rules: Ace Dealer & Trick Collection)
 * ================================================================
 */
...
// مرحله اول: پخش ۵ کارت اول به حاکم و سایرین برای تعیین حکم
...
function resolveTrick() {
    ...
    showToast(`${winnerPlayer.name} این دست را برد! 🏆`, "🏆", 1400);
...
function finishRound() {
    ...
    // قوانین چرخش حاکم: اگر تیم حاکم (فرض تیم A) ببازه، حاکم در جهت خلاف عقربه‌های ساعت می‌چرخد
    if (!teamAWon) {
...
function initializeApp() {
    ...
    showScreen("homeScreen");
    console.log("Hokm game.js 2.9 fully initialized.");
}
